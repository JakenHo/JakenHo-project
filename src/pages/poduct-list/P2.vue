            ...
            <div class="col-10" style="margin-bottom: 10px">
              <div class="col">
                ...
                <input
                  ...
                  value="黑金传奇"
                />
                <input type="button" class="diy-btn-big" value="星际银" />
              </div>
            </div>
            ...
            <div class="col-10" style="margin-bottom: 20px">
              <div class="col">
                <input
                  ...
                  value="12GB+256GB"
                />
                <input type="button" class="diy-btn-big" value="16GB+512GB" />
                <input
                  type="button"
                  class="diy-btn-big diy-btn-big-gray"
                  value="8GB+256GB"
...
export default {
  ...
  mounted() {
    //接收App组件的页面数据
    this.$bus.$on("sentPTowData2", this.sentPTowData2);
    this.sentPTwoData();
  },
};
</script>
