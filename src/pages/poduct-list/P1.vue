        ...
        <div class="col-6">
          ...
          <div class="row" style="margin-bottom: 20px">
            ...
            <div class="col-10" style="margin-bottom: 10px">
              <div class="col">
                <input type="button" class="diy-btn-big" value="浩瀚黑" />
                <input
                  type="button"
            ...
            <div class="col-10" style="margin-bottom: 20px">
              <div class="col">
                <input type="button" class="diy-btn-big" value="12GB+256GB" />
                <input
                  type="button"
                  class="diy-btn-big diy-btn-big-gray"
                  value="16GB+512GB"
...
export default {
  ...
  methods: {
    ...
    addProduct() {
      ...
      const productObj = {
        id: nanoid(),
        title: this.phoneData.title,
        price: this.phoneData.price,
      };
      this.$bus.$emit("addProduct", productObj);
      console.log("传输成功");
    },
  },
  watch: {
  ...
  mounted() {
    //接收App组件的页面数据(原先事件总线传递的数值被路由传参代替)
    this.$bus.$on("sentPOneData1", this.sentPOneData1);
    this.sentPOneData();
  },
};
</script>
